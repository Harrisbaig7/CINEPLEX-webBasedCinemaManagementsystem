...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="**********"><br>
                </div>
            ...
            <a class="col-lg-4 offset-lg-3 col-10 offset-2" href="<?php echo e(route('register')); ?>">Don't Have an Account? <strong> REGISTER</strong></a>
...
<?php /**PATH C:\Softwares\Xammp\htdocs\Laravel\Cinema-Management-System\resources\views/auth/login.blade.php ENDPATH**/ ?>