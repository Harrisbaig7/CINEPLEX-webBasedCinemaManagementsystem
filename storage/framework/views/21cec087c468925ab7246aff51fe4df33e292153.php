<?php $__env->startSection('title'); ?> Admin - Home <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <?php ($movie_covers = ["covers/2.jpg", "covers/1.jpg","covers/Top-Gun-2.jpg","covers/samaritan-2022.jpg","covers/6.jpeg"]); ?>
            ...
            <?php $__currentLoopData = $screen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card col-xl-3 mx-3 my-3 bg-dark text-white" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/admin/movieDetails/<?php echo e($item[1]); ?>" class="btn btn-primary">details</a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Softwares\Xammp\htdocs\Laravel\Cinema-Management-System\resources\views/admin/home.blade.php ENDPATH**/ ?>